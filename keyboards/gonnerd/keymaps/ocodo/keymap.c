...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP_TKL( \
                   ...
                   __CTBS_,    KC_A,      KC_S,  KC_D,  KC_F,   KC_G,   KC_H,   KC_J,    KC_K,     KC_L,  KC_SCLN,  KC_QUOT,     _x_, __CTEN_,                             \
  ...
  [1] = KEYMAP_TKL(\
                   ...
                   _CAX,       KC_4,      KC_5,  KC_6,  __SL,   __AS,    _x_,    _x_,     _x_,      _x_,    _CLN_,   _QUOT_,     _x_,     _x_,                             \
