...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(\
         ...
         __CTBS_,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   TD_CL, TD_QOT,           __CTEN_, \
  ...
  KEYMAP(
         ...
         __CTBS_,    KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,  TD_QOT,          __CTEN_, \
  ...
  KEYMAP(
         ...
         __ALTB_,  TD_QOT, KC_COMM,  KC_DOT,    KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L, KC_SLSH,  KC_EQL, __ALBS_,        KC_DEL,  KC_END, KC_PGDN, \
  ...
  /* WORKMAN_LAYER */
   KEYMAP(
         ...
         __CTBS_,    KC_A,    KC_S,    KC_H,    KC_T,    KC_G,    KC_Y,    KC_N,    KC_E,    KC_O,    KC_I,  TD_QOT,           __CTEN_, \
