...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(\
         ...
         __CTBS_,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   TD_CL, TD_QUOT,          __CTEN_, \
  ...
  KEYMAP(\
         ...
         _CAX,       KC_4,    KC_5,    KC_6,    __SL,    __AS, _x_, _x_, _x_, _x_, _x_, _x_,          _x_, \
  ...
  KEYMAP(
         ...
         __GUGR_,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, __GUBK_,        KC_INS, KC_HOME, KC_PGUP, \
         __ALTB_,    KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,   TD_CL, KC_LBRC, KC_RBRC, __ALBS_,        KC_DEL,  KC_END, KC_PGDN, \
         __CTBS_,    KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O, TD_QUOT,          __CTEN_, \
  ...
  KEYMAP(
         ...
         __ALTB_, TD_QUOT, KC_COMM,  KC_DOT,    KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L, KC_SLSH,  KC_EQL, __ALBS_,        KC_DEL,  KC_END, KC_PGDN, \
         __CTBS_,    KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S, KC_MINS,          __CTEN_, \
         KC_LSFT,   TD_CL,    KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,                   KC_RSFT,                  KC_UP, \
         KC_LCTL, KC_LALT, KC_LGUI,                    __CTSP_,                                     KC_RGUI, KC_RALT,   MO(1), KC_RCTL,       KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  /* WORKMAN_LAYER */
   KEYMAP(
         KC_ESC,             KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,   KC_F12,      KC_PSCR, KC_SLCK, KC_PAUS, \
         __GUGR_,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL,  __GUBK_,       KC_INS, KC_HOME, KC_PGUP, \
         __ALTB_,    KC_Q,    KC_D,    KC_R,    KC_W,    KC_B,    KC_J,    KC_F,    KC_U,    KC_P,   TD_CL, KC_LBRC, KC_RBRC,  __ALBS_,       KC_DEL,  KC_END, KC_PGDN, \
         __CTBS_,    KC_A,    KC_S,    KC_H,    KC_T,    KC_G,    KC_Y,    KC_N,    KC_E,    KC_O,    KC_I, TD_QUOT,           __CTEN_, \
