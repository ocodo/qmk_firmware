...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ,---------.  ,------------------------------------------------------------.  ,---------.
   * |    |    |  |Esc~| 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 |  0| - | = |Backspa|  |BSpc|PgUp|
   * |---------|  |------------------------------------------------------------|  |---------|
  ...
  [OCODO] = KEYMAP(
                   KC_NO,   KC_NO,    KC_FN1,    KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,    KC_9,   KC_0,      KC_MINS,   KC_EQL,     KC_BSPC,    KC_BSPC,  KC_PGUP,
