...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(\
         ...
         _TIX,       KC_A,   KC_B,    KC_C,    KC_D,    KC_E,  KC_F, _x_,     _x_,     _x_,     _x_,     _x_,     _x_,     _x_,       _x_,      _x_,     _x_, \
         _TAX,       KC_7,   KC_8,    KC_9,    __PL,    __MI,   _x_, _x_,     _x_,     _x_,     _x_,     _x_,     _x_,     _x_,       _x_,      _x_,     _x_, \
         _CAX,       KC_4,   KC_5,    KC_6,    __SL,    __AS,   _x_, _x_,     _x_,     _x_,     _x_,     _x_,              _x_, \
         _LSX,       KC_1,   KC_2,    KC_3,    KC_0,    __DT,   _x_, _x_,     _x_,     _x_,     _x_,                       _x_,                _x_, \
         _x_,         _x_,   __EN,                     TG(2),                                   _x_,     _x_,     _x_,  KC_APP,       _x_,     _x_,      _x_),

  /* Layer 2: Mouse keys (FN + Space to toggle) */
  KEYMAP(\
         _x_,             _NM_,    _EM_,    _GH_,    _HT_,   _SSL_,    _PN_,    _PV_,    _PT_, _x_, _x_, _x_, _x_,       KC_BTN3, KC_BTN4, KC_BTN5, \
