...
/* Keymap _FL: Function Layer
   ...
   * ├───┴─┬─┴┬──┴┬──┼──┬┴─┬─┴─┬─┴──┬┴──┬┴──┬┴───┼───┴┬──┴─┬─────┤
   * │     │  │   │JM│GM│GH│HTP│HTPS│Ins│   │PrSc│Sclk│Paus│     │
   * ├─────┴┬─┴──┬┴──┴┬─┴─┬┴──┬┴──┬─┴┬──┼───┼───┬┴───┬┴───┬┴─────┤
   * │      │    │    │   │JMP│PIV│  │  │   │   │Home│PgUp│      │
   * ├──────┴─┬──┴┬───┼──┬┴─┬─┴─┬─┴─┬┴──┼───┴┬──┴┬───┴┬───┴──────┤
...
[_FL] = KEYMAP_ANSI(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, JM23,    GMAIL,   GHUB,    HTTP,    HTTPS,    KC_INS,  KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, JMPIV,   PIVIO,   KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_HOME, KC_PGUP,          KC_TRNS, \
