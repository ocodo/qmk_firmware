...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP_ANSI(
                    ...
                    KC_CAPS, KC_A,    KC_S,    KC_D,   KC_F,     KC_G,    KC_H,    KC_J,     KC_K,    KC_L,   KC_SCLN,  KC_QUOT,          KC_RETURN, \
  ...
  [1] = KEYMAP_ANSI(
                    ...
                    _x_,     _x_,     KC_UP,   _x_,      _x_,     _x_,    _x_,     _x_,      KC_INS,  _x_,     KC_PSCR, KC_SLCK, KC_PAUS,  _x_,    \
                    _CAX,    KC_LEFT, KC_DOWN, KC_RIGHT, _x_,     _x_,    _x_,     _x_,      _KDB_,   _x_,     KC_HOME, KC_PGUP,           _x_,    \
