...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ├────┬───┴┬──┴─┬─┴───┴───┴───┴───┴───┴─┬─┴──┬┴───┼────┬─────┤
   * │Ctrl│Alt │Gui │         Space         │Fn  │Lt/G│Dn/A│Rt/Ct│
   * ╰────┴────┴────┴───────────────────────┴────┴────┴────┴─────╯
   */
[_BL] = KEYMAP_ANSI(
  ...
  KC_LCTL, KC_LALT, KC_LGUI,                           KC_SPC,                             MO(_FL), LEFT_T,  DOWN_T,  RIGHT_T),

/* Keymap _FL: Function Layer
   * ╭───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────╮
   * │ ~ │ F1│F2 │F3 │F4 │F5 │F6 │F7 │F8 │F9 │F10│F11│F12│  DEL  │
   * ├───┴─┬─┴┬──┴┬──┼──┬┴─┬─┴─┬─┴──┬┴──┬┴──┬┴───┼───┴┬──┴─┬─────┤
   * │     │  │   │  │GM│GH│HTP│HTPS│Ins│   │PrSc│Sclk│Paus│     │
   * ├─────┴┬─┴──┬┴──┴┬─┴─┬┴──┬┴──┬─┴┬──┼───┼───┬┴───┬┴───┬┴─────┤
   * │      │    │    │   │   │   │  │  │   │   │Home│PgUp│      │
   * ├──────┴─┬──┴┬───┼──┬┴─┬─┴─┬─┴─┬┴──┼───┴┬──┴┬───┴┬───┴──────┤
...
[_FL] = KEYMAP_ANSI(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, GMAIL,   GHUB,    HTTP,    HTTPS,    KC_INS,  KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_HOME, KC_PGUP,          KC_TRNS, \
