...
#define DOWN_T    GUI_T(KC_DOWN)
#define LEFT_T    ALT_T(KC_LEFT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP_ANSI(
                    ...
                    __CTBS_, KC_A,    KC_S,    KC_D,   KC_F,     KC_G,    KC_H,    KC_J,     KC_K,    KC_L,   KC_SCLN,  KC_QUOT,          KC_ENT, \
...
| Key                    | Tap      | Hold        |
|------------------------|----------|-------------|
| <kbd>Up</kbd>           | <kbd>Up</kbd>       | <kbd>Shift</kbd>       |
| <kbd>Down</kbd>         | <kbd>Down</kbd>     | <kbd>Alt</kbd>         |
| <kbd>Left</kbd>         | <kbd>Left</kbd>     | <kbd>GUI</kbd>         |
| <kbd>Right</kbd>        | <kbd>Right</kbd>    | <kbd>Ctrl</kbd>     |
| <kbd>Caps</kbd>        | <kbd>Backspace</kbd>    | <kbd>Ctrl</kbd>     |
...
| <kbd>Fn</kbd> + <kbd>GUI</kbd> + <kbd>Esc</kbd> | <kbd>\`</kbd> |
